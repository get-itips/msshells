...
|Azure Az PowerShell|[Az](https://www.powershellgallery.com/packages/Az/)|6.1.0|```Install-Module -Name Az```|N/A|N/A|```Connect-AzAccount``` [More methods](https://docs.microsoft.com/en-us/powershell/module/az.accounts/connect-azaccount)|Yes|
